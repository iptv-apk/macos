...
alias avd='~/Library/Android/sdk/emulator/emulator -avd SuperTablet_API_29'
alias power='system_profiler SPPowerDataType' #show macbook power charging status using command line
